        ...
        for h in cases:
            ...
            with Bar("Creazione connessioni...", max=mesh.num_cells()) as bar:
                for i, j in enumerate(cells(mesh)):
                    ...
                    c, c_rev, d = CreateData.create_connection(self, dofs_list_cell, coord_dofs_cell, int(3), int(2))
                    if (c != None) and c not in C:
                        C.append(c)
                        C.append(c_rev)
                        D.append(d)
                    ...
                    c, c_rev, d = CreateData.create_connection(self, dofs_list_cell, coord_dofs_cell, int(4), int(0))
                    if (c != None) and c not in C:
                        C.append(c)
                        C.append(c_rev)
                        D.append(d)
                    ...
                    c, c_rev, d = CreateData.create_connection(self, dofs_list_cell, coord_dofs_cell, int(4), int(2))
                    if (c != None) and c not in C:
                        C.append(c)
                        C.append(c_rev)
                        D.append(d)
                    ...
                    c, c_rev, d = CreateData.create_connection(self, dofs_list_cell, coord_dofs_cell, int(5), int(0))
                    if (c != None) and c not in C:
                        C.append(c)
                        C.append(c_rev)
                        D.append(d)
                    ...
                    c, c_rev, d = CreateData.create_connection(self, dofs_list_cell, coord_dofs_cell, int(5), int(1))
                    if (c != None) and c not in C:
                        C.append(c)
                        C.append(c_rev)
                        D.append(d)
